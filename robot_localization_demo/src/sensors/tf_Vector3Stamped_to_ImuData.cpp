...
namespace robot_localization_demo {
  ...
  Turtletf_Vector3Stamped_to_ImuData::Turtletf_Vector3Stamped_to_ImuData(ros::NodeHandle node_handle, double frequency,
    ...
    turtle_imudata_subscriber_{node_handle_.subscribe("turtle1/sensors/imu", 16, &Turtletf_Vector3Stamped_to_ImuData::turtleImu_data_Callback, this)},
    turtle_imurpy_subscriber_{node_handle_.subscribe("turtle1/sensors/imu_rpy", 16, &Turtletf_Vector3Stamped_to_ImuData::turtleImu_rpy_Callback, this)},
    turtle_tf_Vector3Stamped_to_ImuData_publisher_{node_handle_.advertise<sensor_msgs::Imu>("turtle1/created/imu_data", 16)},
  ...
  void Turtletf_Vector3Stamped_to_ImuData::spin() {
    ...
    while(node_handle_.ok()) {
      ...
      current_imu_data.header.frame_id = "base_imu";
      ...
      current_imu_data.orientation = tf::createQuaternionMsgFromRollPitchYaw(0., 0., measurement_rpy.vector.z);
