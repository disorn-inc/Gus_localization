...
int main(int argc, char ** argv) {
  ...
  ros::init(argc, argv, "tf_Odometry_to_ImuData");
  ros::NodeHandle node_handle;

  robot_localization_demo::tf_Odometry_to_ImuData tf_Odometry_to_imudata{node_handle, frequency,
