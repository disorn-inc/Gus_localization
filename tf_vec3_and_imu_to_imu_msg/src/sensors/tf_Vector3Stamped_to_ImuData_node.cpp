...
int main(int argc, char ** argv) {
  ...
  ros::init(argc, argv, "turtle_tf_Vector3Stamped_to_ImuData");
  ros::NodeHandle node_handle;

  robot_localization_demo::Turtletf_Vector3Stamped_to_ImuData turtle_tf_vector3stamped_to_imudata{node_handle, frequency,
  ...
  turtle_tf_vector3stamped_to_imudata.spin();
