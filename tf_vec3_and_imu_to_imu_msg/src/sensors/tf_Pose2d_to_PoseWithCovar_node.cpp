...
int main(int argc, char ** argv) {
  ...
  ros::init(argc, argv, "tf_Pose2D_to_PoseWithCovar");
  ros::NodeHandle node_handle;

  robot_localization_demo::tf_Pose2D_to_PoseWithCovar tf_Pose2D_to_PoseWithCovar{node_handle, frequency,
  ...
  tf_Pose2D_to_PoseWithCovar.spin();
